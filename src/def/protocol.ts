...
export const enum errcode {
    ...
    LEVEL_LIMIT = 0x1022,
    TROOP_IDX_ERROR = 0x1023,
    SOLDIER_ID_ERROR = 0x1024,
    SODLIER_POS_ERROR = 0x1025,
    PENDANT_ID_ERROR = 0x1026,
    PENDANT_POS_ERROR = 0x1027,
    PENDANT_STATION_ERROR = 0x1028,
    HERO_NOT_EXIST = 0x1029,
    SOLDIER_NOT_EXIST = 0x102A,
    PENDANT_NOT_EXIST = 0x102B,
    ARGS_ERROR = 0xA000,
    BODY_ERROR = 0xA001,
    AUTH_FAIL = 0xA002,
    TRACEBACK = 0xA003,
...
export const errname = {
    ...
    0x1022: "LEVEL_LIMIT",
    0x1023: "TROOP_IDX_ERROR",
    0x1024: "SOLDIER_ID_ERROR",
    0x1025: "SODLIER_POS_ERROR",
    0x1026: "PENDANT_ID_ERROR",
    0x1027: "PENDANT_POS_ERROR",
    0x1028: "PENDANT_STATION_ERROR",
    0x1029: "HERO_NOT_EXIST",
    0x102A: "SOLDIER_NOT_EXIST",
    0x102B: "PENDANT_NOT_EXIST",
    0xA000: "ARGS_ERROR",
    0xA001: "BODY_ERROR",
    0xA002: "AUTH_FAIL",
    0xA003: "TRACEBACK",
